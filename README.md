...
[![Build Status](https://secure.travis-ci.org/bevry/docpad-plugin-jade.png?branch=master)](http://travis-ci.org/bevry/docpad-plugin-jade "Check this project's build status on TravisCI")
